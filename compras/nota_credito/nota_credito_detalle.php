                ...
                <div class="content">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <?php } ?>
                            <!-- MENSAJE -->
                            <h3 style="color: red" >Nota Credito - Detalle</h3>
                            <!--CABECERA-->
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    $confirmar = consultas::get_datos("SELECT * FROM v_nota_de_credito WHERE cod_notc = $idpedido");
                                    if (!empty($confirmar)) {
                                        ?>
                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                            <?php
                                            $idpedido = $_REQUEST['vidnota'];
                                            $pedidosc = consultas::get_datos("SELECT * FROM v_nota_de_credito WHERE cod_notc = $idpedido ");
                                            if (!empty($pedidosc)) {
                                                ?>
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body no-padding">
                                    <div class="col-lg-12 col-md-12 col-xs-12">
                                        <?php
                                        $idpedido = $_REQUEST['vidnota'];
                                        $pedidoscdetalle = consultas::get_datos("SELECT * FROM v_detalle_credito WHERE cod_notc=$idpedido");
                            ...
                            <?php
                            $idpedido = $_REQUEST['vidnota'];
                            $detalle_debito = consultas::get_datos("SELECT * FROM v_nota_de_credito WHERE cod_notc= $idpedido");
                                                        ...
                                                        <div class="box-body" style="left: 1000px;">
                                                            ...
                                                            <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                                                                        <?php $productos = consultas::get_datos("SELECT * FROM v_compras_detalle WHERE id_compra = (SELECT id_compra FROM nota_de_credito WHERE cod_notc = " . $_REQUEST['vidnota'] . ")") ?>
                                                                ...
                                                                <div class="form-group" id="precio">
                                                                    ...
                                                                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                                                                        <input type="number" name="vprecio" class="form-control" max="10000000" min="5000" required=""  style="width: 300px;">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
