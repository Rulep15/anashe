...
<div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
    <input type="number" required="" placeholder="Precio Articulo" class="form-control"
           name="vprecio" value="<?php echo $productos[0]['precio_costo']?>"
           id="idprecio" min="1" style=" width: 300px">
</div>
<?php } else { ?>
