                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            <div class="box box-primary">
                                ...
                                <form action="orden_compra_control.php" method="POST" accept-charset="UTF-8" class="form-horizontal">
                                    <div class="box-body">
                                        <?php $resultado = consultas::get_datos("SELECT * FROM v_orden_de_compra WHERE nro_orden =" . $_GET['vidordencompra']); ?>
                                        <div class="form-group">
                                            <input type="hidden" name="voperacion"  value="2">
                                            <input type="hidden" name="vcodigo" value="<?php echo $resultado[0]['nro_orden']; ?>"/> 
