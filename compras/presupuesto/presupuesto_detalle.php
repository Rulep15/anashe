                ...
                <div class="content">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <?php } ?>
                            <!-- MENSAJE -->
                            <h3 style=" color: red;">Presupuesto Detalle</h3>
                            <!--CABECERA-->
                            <div class="box box-primary">
                                <div class="box-header" style=" background-color: #14d1ff;">
                                    <i class="ion ion-clipboard"></i>
                                    <h3 class="box-title" style=" color: black;">Cabecera</h3>
                                    <a href="presupuesto_confirmar.php?vidpresupuesto=<?php echo $_REQUEST['vidpresupuesto'] ?>"
                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                            ...
                                            $pedidosc = consultas::get_datos("SELECT * FROM v_presupuesto WHERE id_presu = $idpedido ");
                                            if (!empty($pedidosc)) {
                                                ?>
                            ...
                            <div class="box box-primary">
                                <div class="box-header" style=" background-color: #14d1ff;">
                                    <i class="ion ion-clipboard"></i>
                                    <h3 class="box-title" style=" color: black;">Detalles Items</h3>
                                </div>
                                <div class="box-body no-padding">
                                    <div class="col-lg-12 col-md-12 col-xs-12">
                                        <?php
                                        $idpedido = $_REQUEST['vidpresupuesto'];
                                        $pedidoscdetalle = consultas::get_datos("SELECT * FROM v_detalle_presupuesto WHERE id_presu = $idpedido");
                                                        ...
                                                        <?php foreach ($pedidoscdetalle AS $pcd) { ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-center"> 
                                                                    <?php if ($pc['estado'] == 'ACTIVO') { ?>
                                                                        <a onclick="editar(<?php echo "'" . $pcd['id_presu'] . "_" . $pcd['pro_cod'] . "_" . $pcd['id_depo'] . "_" . $pcd['cantidad'] . "'"; ?>)" class="btn btn-toolbar " role="button" data-title="Modificar Precio" data-placement="top" rel="tooltip" data-toggle="modal" data-target="#editar">
    ...
    <SCRIPT>
        ...
        function obtenerprecio() {
            ...
            if (parseInt($('#idproducto').val()) > 0) {
                $.ajax({
                    type: "GET",
                    url: "/anashe/compras/presupuesto/listar_precios.php?vidproducto=" + dat[0], cache: false,
                    beforeSend: function () {
