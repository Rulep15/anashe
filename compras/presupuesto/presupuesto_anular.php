                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Anular Presupuesto</h3>
                                    <div class="box-tools">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div  class="form-group-lg form-group-sm">
                                            ...
                                            <div class="form-group">    
                                                ...
                                                <div class="col-lg-8">
                                                    <input class="form-control" type="text" name="vcodigo" readonly="" value="<?php echo $resultado[0]['id_presu']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">    
                                                <label class="col-lg-2 control-label">Proveedor</label>
                                                <div class="col-lg-8">
                                                    <input class="form-control" type="text" name="vproveedor" readonly="" value="<?php echo $resultado[0]['prv_cod']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-lg-6 col-sm-6 col-xs-7">
                                                    <input class="form-control" type="number" name="vdescripcion" readonly="" value="<?php echo $resultado[0]['total']; ?>">
                                                </div>
                                            </div>
                                    </div>
                                    <div class="box-footer" style="text-align: right;">
                                        <button class="btn btn-danger fa fa-ban" type="submit">Anular</button>
                                    </div>
                                </form>
                            </div>
                        </div>
