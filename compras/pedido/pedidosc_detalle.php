                ...
                <div class="content">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <?php } ?>
                            <!-- MENSAJE -->
                            <h3 style=" color: red;">Pedidos de Compras - Detalle</h3>
                            <!--CABECERA-->
                                                    ...
                                                    <div class="box-body" style="left: 1000px;">
                                                        ...
                                                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                                                                    <input type="number" name="vcantidad" max="500"  class="form-control" required="" min="1" value="1" style="width: 300px;" id="idcantidad" onchange="calsubtotal()" onkeydown="calsubtotal()">
                                                                </div>
                                                            </div>
    ...
    <SCRIPT>
        ...
        function obtenerprecio() {
            ...
            if (parseInt($('#idproducto').val()) > 0) {
                $.ajax({
                    type: "GET",
                    url: "/anashe/compras/pedido/listar_precios.php?vidproducto=" + dat[0],
                    cache: false,
                    beforeSend: function () {
                    },
