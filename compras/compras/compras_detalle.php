                ...
                <div class="content">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <?php } ?>
                            <!-- MENSAJE -->
                            <h3 style=" color: red;"> Compras - Detalle</h3>
                            <!--CABECERA-->
                            <div class="box box-primary">
                                <div class="box-header" style=" background-color: #14d1ff;">
                                    <i class="ion ion-clipboard"></i>
                                    <h3 class="box-title" style=" color: #0000ff;">Cabecera</h3>
                                    <a href="compras_confirmar.php?vidcompra=<?php echo $_REQUEST['vidcompra'] ?>"
                                                    ...
                                                    <table class="table col-lg-12 col-md-12 col-xs-12">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="text-center">Proveedore</th>
                            ...
                            <div class="box box-primary">
                                <div class="box-header" style=" background-color: #14d1ff;">
                                    <i class="ion ion-clipboard"></i>
                                    <h3 class="box-title" style=" color: #0000ff;">Detalles Compra</h3>
                                </div>
                                <div class="box-body no-padding">
                                    <div class="col-lg-12 col-md-12 col-xs-12">
                                        <?php
                                        $idcompra = $_REQUEST['vidcompra'];
                                        $compradetalle = consultas::get_datos("SELECT * FROM v_compras_detalle WHERE id_compra= $idcompra  AND pro_cod NOT IN (SELECT a.pro_cod FROM detalle_orden a, orden_de_compra b, compras c, compras_detalle d WHERE a.nro_orden = b.nro_orden AND b.nro_orden = c.nro_orden AND c.id_compra = d.id_compra AND c.id_compra = $idcompra)");
                                        if (!empty($compradetalle)) {
                                            ...
                                            <div class="table-responsive">
                                                <table class="table col-lg-12 col-md-12 col-xs-12 table-bordered">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($compradetalle AS $cd) { ?>
                                                            <tr>
                            ...
                            <!--AGREGAR DETALLE-->
                            <?php if ($c['com_estado'] == 'ACTIVO') { ?>
                                <div class="box box-primary" style="width: 550px; height: 400px;margin: 0 auto;">
                                    <div class="box-header">
                                        <i class="ion ion-clipboard"></i>
                                                    ...
                                                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                                                        ...
                                                        <div class="form-group" id="">
                                                            ...
                                                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6 ">
                                                                ...
                                                                <select class="form-control" name="vproducto" required="" style="width: 300px;"
                                                        ...
                                                        <div class="form-group" id="precio">
                                                            ...
                                                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                                                                <input type="text" readonly="" placeholder="Precio del Articulo"
                                                                       class="form-control" name="vprecio" style="width: 300px;" >
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                                                                <input type="hidden" name="vsubtotal" class="form-control" readonly=""
                                                                       min="0" value="0" style="width: 300px;" id="idsubtotal">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <SCRIPT>
        ...
        function obtenerprecio() {
            ...
            if (parseInt($('#idproducto').val()) > 0) {
                $.ajax({
                    type: "GET",
                    url: "/anashe/compras/compras/listar_precios.php?vidproducto=" + dat[0], cache: false,
                    beforeSend: function () {
