...
$sqls = consultas::get_datos("SELECT * FROM v_ref_sucursal ORDER BY id_sucursal");
foreach ($sqls AS $sql){
    $pdf->Cell(20, 5, $sql['id_sucursal'], 1, 0, 'C', 1);
    $pdf->Cell(20, 5, $sql['id_ciudad'], 1, 0, 'C', 1);
    $pdf->Cell(70, 5, $sql['ciu_descri'], 1, 0, 'C', 1);
    $pdf->Cell(70, 5, $sql['suc_descri'], 1, 0, 'C', 1);
    $pdf->Cell(50, 5, $sql['suc_telefono'], 1, 0, 'C', 1);
