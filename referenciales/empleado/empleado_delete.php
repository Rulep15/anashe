                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div class="box box_primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title"> Inhabilitar Empleado</h3>
                                    <div class="box-tools">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control select3" disabled="" name="vidpersona" required="" style="width: 320px;">  
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control select3" disabled="" name="vidcargo" required="" style="width: 320px;">  
                ...
                <div class="modal fade" id="registrar_cargo" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="empleado_control.php" method="POST" accept-charset="UTF-8" class="form-horizontal">
                                <input type="hidden" name="voperacion" value="4">
                                <input type="hidden" name="vidcargo" value="0" id="vidmarca">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-2">Descripcion</label>
                                        <div class="col-xs-10 col-md-10 col-lg-10">
                                            <input type="text" class="form-control" name="vdescripcion" required="" id="vmardescri">
                                        </div>
                                    </div>
                                 </div>
                                <div class="box-footer">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                            ...
                                            <div class="col-lg-4 col-sm-4 col-xs-4">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control select3" name="vidcargo" required="" style="width: 150px;">
                                                        <?php
                                                        if (!empty($paiss)) {
                                                            foreach ($paiss as $m) {
                                                                ?>
                                    ...
                                    <div class="form-group">
                                      <label class="control-label col-lg-3 col-sm-2 col-xs-2" >Telefono</label>
                                            <div class="col-lg-4 col-sm-4 col-xs-4">
                                            <input type="text" class="form-control" name="vsuctelefono" required="" id="vmardescri">
                                        </div>
                                    </div>
                                    <div class="form-group">
