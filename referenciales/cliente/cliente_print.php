...
$sqls = consultas::get_datos("SELECT * FROM v_ref_cliente ORDER BY id_cliente");
foreach ($sqls AS $sql){
    $pdf->Cell(20, 5, $sql['id_cliente'], 1, 0, 'C', 1);
    $pdf->Cell(20, 5, $sql['id_persona'], 1, 0, 'C', 1);
    $pdf->Cell(60, 5, $sql['per_nombre'], 1, 0, 'C', 1);
    $pdf->Cell(60, 5, $sql['cli_ci'], 1, 0, 'C', 1);
    $pdf->Cell(60, 5, $sql['nombres'], 1, 0, 'C', 1);
    $pdf->Ln();
}
//SALIDA AL NAVEGADOR
