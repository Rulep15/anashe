...
<HTML>
                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Tipo de Impuestos</h3>
                                    <div class="box-tools">
                                        <a class="btn btn-primary pull-right btn-sm" role="button"
                                           data-toggle="modal" data-target="#registrar">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                        <a href="tipo_de_impuesto_print.php" class="btn btn-success btn-sm pull-right" target="_blank">
                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                            <!--BUSCADOR-->
                                            <form action="tipo_de_impuesto_index.php" method="POST" accept-charset="UTF-8" class="form-horizontal">
                                                <div class="box-body">
                                            ...
                                            $tipo_impuesto = consultas::get_datos("SELECT * FROM ref_tipo_impuesto WHERE (id_timp||TRIM(UPPER(descripcion)||(porcentaje))) LIKE TRIM(UPPER('%". $valor."%')) ORDER BY id_timp");
                                            if (!empty($tipo_impuesto)) {
                                                ?>
                                                <div class="table-responsive">
                                                    <table class="table col-lg-12 col-md-12 col-xs-12">
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($tipo_impuesto AS $impuesto) { ?>
                                                                <tr>
                                                                    <td class="text-center"> <?php echo $impuesto['id_timp']; ?></td>
                                                                    <td class="text-center"> <?php echo $impuesto['descripcion']; ?></td>
                                                                    <td class="text-center"> <?php echo $impuesto['porcentaje']; ?></td>
                                                                    <td class="text-center">
                                                                        <a onclick="editar(<?php echo "'" . $impuesto['id_timp'] . "_" . $impuesto['descripcion'] . "_" . $impuesto['porcentaje'] . "'"; ?>)" 
                                                                        ...
                                                                        <a onclick="borrar(<?php echo "'" . $impuesto['id_timp'] . "_" . $impuesto['descripcion'] . "_" . $impuesto['porcentaje'] . "'" ; ?>)" 
    ...
    <script>
        ...
        function borrar(datos) {
            var dat = datos.split("_");
            $('#si').attr('href', 'tipo_de_impuesto_control.php?vidtimp=' + dat[0] + '&vtdescripcion=' + dat[1] + '&vporcentaje=' + dat[2] + '&voperacion=3');
