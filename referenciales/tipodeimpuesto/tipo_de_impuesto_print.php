...
$pdf->SetTitle('REPORTE DE TIPO DE IMPUESTO');
...
$sqls=  consultas::get_datos("SELECT * FROM ref_tipo_impuesto ORDER BY id_timp");
foreach ($sqls AS $sql){
    $pdf->Cell(80, 5, $sql['id_timp'], 1, 0, 'C', 1);
    $pdf->Cell(80, 5, $sql['descripcion'], 1, 0, 'C', 1);
    $pdf->Cell(80, 5, $sql['porcentaje'], 1, 0, 'C', 1);
    $pdf->Ln();
}
//SALIDA AL NAVEGADOR
$pdf->Output('reporte_tipo_de_impuesto.pdf', 'I');
?>
