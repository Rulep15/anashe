...
$pdf->AddPage('P', 'LEGAL');
//FORMATO DE TITULO
$pdf->Cell(0, 0, "REPORTE DE PAIS", 0, 1, 'C');
//SALTO DE LINEA
$pdf->ln();
//TABLA 
...
$sqls=  consultas::get_datos("SELECT * FROM ref_pais ORDER BY id_pais");
foreach ($sqls AS $sql){
    $pdf->Cell(80, 5, $sql['id_pais'], 1, 0, 'C', 1);
    $pdf->Cell(80, 5, $sql['pai_descri'], 1, 0, 'C', 1);
    $pdf->Ln();
}
//SALIDA AL NAVEGADOR
$pdf->Output('reporte_pais.pdf', 'I');
?>