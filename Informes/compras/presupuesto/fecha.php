...
<form accept-charset="UFT8" class="form-horizontal" onsubmit="return showValues();">
    <input name="vopcion" value="1" id="opcion" type="hidden">
...
<script>
    function enviar() {
        window.open("/T.A/informes/compras/presupuesto/presupuesto_print.php?vdesde=" + "'" + $('#iddesde').val() + "'" + "&vhasta=" + "'" + $('#idhasta').val() + "'" + "&vopcion=" + $('#opcion').val(), '_blank');
    }
</script>
<script>
//     function hasta() {
