...
<form accept-charset="UTF8" class="form-horizontal">
    ...
    <div class="col-md-6 col-md-offset-0">
        <div class="list-group">
            <a href="#" class="list-group-item active" style="background-color: #465F62;">Reportes de Compras por Estado</a>
        </div>
...
<script>
    function enviar() {
        window.open("/anashe/informes/compras/compras/impresion.php?vciudad=" + "'" + $('#vestado').val() + "'" + '&vopcion=' + $('#opcion').val(), '_blank');
