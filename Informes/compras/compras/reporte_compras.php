...
<html>
    ...
    <form accept-charset="UTF8" class="form-horizontal">
        <div class="col-md-8 col-md-offset-0">
            <div style="width: 218px;" class="list-group">
                <a  href="#" class="list-group-item active" style="background-color: #465F62">Reportes de Compras</a>
            </div>
    ...
    <script>
        function obtener_fecha() {
            $.ajax({
                type: 'POST',
                url: "/T.A/informes/compras/compras/fecha.php",
                cache: false,
                beforeSend: function () {
        ...
        function obtener_estado() {
            $.ajax({
                type: 'POST',
                url: "/T.A/informes/compras/compras/estado.php",
                cache: false,
                beforeSend: function () {
                    $('#cargando').html('<img src="/T.A/img/sistema/ajax-loader.gif"><strong><i>Cargando...</i></strong>');
                },
